...
function Modal5({ modal1Handle, closeBusinessClassificationHandel }) {
  return (
    <div>
      <h1 className="text-textPrimary text-base font-medium">Business Classification</h1>
      <h1 className="text-textPrimary text-base">Select a business classification that best describe your company.</h1>
