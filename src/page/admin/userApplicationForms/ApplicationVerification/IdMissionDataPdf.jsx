      ...
      <form className="flex flex-wrap justify-center gap-4">
        <TextField
          ...
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], name: { name: "name", value: e.target.value } },
            }))
          }
          required
        ...
        <TextField
          isPdf={true}
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.email?.value || ""}
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], email: { name: "email", value: e.target.value } },
            }))
          }
          label="Email Address:*"
          required
        ...
        <TextField
          ...
          isPdf={true}
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.dateOfBirth?.value || ""}
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], dateOfBirth: { name: "dateOfBirth", value: e.target.value } },
            }))
          }
          label="Date of Birth:*"
          required
        ...
        <TextField
          ...
          isPdf={true}
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.idType?.value || ""}
          name="idType"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], idType: { name: "idType", value: e.target.value } },
            }))
          }
          label="Id Type:*"
          required
        ...
        <TextField
          ...
          isPdf={true}
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.idIssuer?.value || ""}
          name="idIssuer"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], idIssuer: { name: "idIssuer", value: e.target.value } },
            }))
          }
          label="Id Issuer:*"
          required
        ...
        <TextField
          ...
          isPdf={true}
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.idExpiryDate?.value || ""}
          name="idExpiryDate"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], idExpiryDate: { name: "idExpiryDate", value: e.target.value } },
            }))
          }
        ...
        <TextField
          ...
          isPdf={true}
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.issueDate?.value || ""}
          name="issueDate"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], issueDate: { name: "issueDate", value: e.target.value } },
            }))
          }
          label="Issue Date:*"
          required
        ...
        <TextField
          ...
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], idNumber: { name: "idNumber", value: e.target.value } },
            }))
          }
        ...
        >
          <TextField
            ...
            required
            disabled={isDisabledAllFields}
            value={formInnerData?.[sectionKey]?.streetAddress?.value || ""}
            name="streetAddress"
            onChange={(e) =>
              setFormInnerData((prev) => ({
                ...prev,
        ...
        <TextField
          ...
          required
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.city?.value || ""}
          name="city"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], city: { name: "city", value: e.target.value } },
            }))
          }
          label="City:*"
          className={"max-w-[400px]!"}
        ...
        <TextField
          ...
          required
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.zipCode?.value || ""}
          name="zipCode"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], zipCode: { name: "zipCode", value: e.target.value } },
            }))
          }
          label="Zip Code:*"
          className={"max-w-[400px]!"}
        ...
        <TextField
          ...
          required
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.state?.value || ""}
          name="state"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], state: { name: "state", value: e.target.value } },
            }))
          }
          label="State:*"
          className={"max-w-[400px]!"}
        ...
        <TextField
          ...
          required
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.country?.value || ""}
          name="country"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], country: { name: "country", value: e.target.value } },
            }))
          }
          label="Country:*"
          className={"max-w-[400px]!"}
        ...
        <TextField
          isPdf={true}
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.companyTitle?.value || ""}
          name="companyTitle"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], companyTitle: { name: "companyTitle", value: e.target.value } },
            }))
          }
          label="Company Title:*"
          required
        ...
        <TextField
          isPdf={true}
          disabled={isDisabledAllFields}
          value={formInnerData?.[sectionKey]?.phoneNumber?.value || ""}
          name="phoneNumber"
          onChange={(e) =>
            setFormInnerData((prev) => ({
              ...prev,
              [sectionKey]: { ...prev?.[sectionKey], phoneNumber: { name: "phoneNumber", value: e.target.value } },
            }))
          }
          label="Phone Number:*"
          required
        ...
        <div className="flex w-full border bg-white p-4">
          <SimpleRadioInputType
            ...
            form={{ roleFillingForCompany: formInnerData?.[sectionKey]?.roleFillingForCompany?.value || "" }}
            onChange={(e) =>
              setFormInnerData((prev) => ({
                ...prev,
                [sectionKey]: {
